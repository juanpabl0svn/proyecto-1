      ...
      >
        <div className="flex gap-10 items-center">
          <div>
            ...
            <img src="/comultrasan-team.png" alt="" className="h-3/4" />
          </div>
          <div>
            ...
            <button
              className="text-white relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md  bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mt-10"
              type="submit"
            >
              Crear usuario
            </button>
